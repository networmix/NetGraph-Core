...
def test_cost_distribution_multiple_paths(build_graph, cost_dist_dict):
    # S=0, A=1, B=2, T=3
...
def test_cost_distribution_single_path(build_graph, cost_dist_dict):
...
def test_cost_distribution_equal_cost_paths(build_graph, cost_dist_dict):
...
def test_cost_distribution_three_tiers(build_graph, cost_dist_dict):
    # S=0, A=1, B=2, C=3, T=4
...
def test_cost_distribution_no_flow(build_graph, cost_dist_dict):
...
def test_cost_distribution_shortest_path_mode(build_graph, cost_dist_dict):
...
def test_cost_distribution_capacity_bottleneck(build_graph, cost_dist_dict):
