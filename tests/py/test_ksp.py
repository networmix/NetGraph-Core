...
PredDAG into a predecessor mapping using EdgeId, similar to SPF tests.
"""
...
def test_ksp_fully_connected_costs(make_fully_connected_graph):
...
def test_ksp_max_cost_factor_limit(make_fully_connected_graph):
    g = make_fully_connected_graph(5, cost=1.0, cap=1.0)
